  ...
  return (
    <footer className="relative bg-gradient-to-b from-slate-900 to-slate-950 text-white overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 md:px-6 py-16">
        ...
        <div className="grid md:grid-cols-3 gap-12 mb-12">
          ...
          >
            ...
            <div className="space-y-2">
              {['About', 'Focus', 'Team', 'Community'].map((item) => (
                <a
                  key={item}
          ...
          >
            ...
            <div className="space-y-3">
              <a
                href="https://discord.gg/MYvQMAAWtj"
                target="_blank"
              ...
              <a
                href="https://www.instagram.com/zion.community/"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 text-gray-400 hover:text-white transition-colors"
              >
              ...
              <a
                href="https://www.linkedin.com/company/zionite/"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 text-gray-400 hover:text-white transition-colors"
              >
              ...
              <a
                href="https://x.com/zioncommunity_"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 text-gray-400 hover:text-white transition-colors"
              >
        ...
        >
          <p>© 2026 Zion Community. All rights reserved.</p>
        </motion.div>
      </div>
    </footer>
  );
